            ...
            <div class="tab-content">
              ...
              <div class="fancy" >
                            ...
                            <div class="top-campaign">
                                <a th:href="@{controlecompte(id=${p.compte.id})}"><p th:text="${p.compte.email}"></p></a>
                                
                                <div class="table-responsive">
                                    <table width="100%" >
               		<tr>
               			<td>Titre : <span th:text="${p.titre}"></span></td>
               			<td>Date expiration : <span th:text="${p.date_expiration}"></span></td>
               		</tr>
               		<tr>
               			<td>Cathegorie : <span  th:text="${p.categories}"></span></td>
               			<td>Salaire : <span  th:text="${p.salaire}"></span></td>
               			
               		</tr>
               		<tr>
               			<td>Poste : <span  th:text="${p.poste}"></span></td>
               			<td>Lieux : <span  th:text="${p.lieu}"></span></td>
               			
               		</tr>
               		<tr>
               			<td colspan="2">Description: <span th:text="${p.description}"></span></td>
               		
               		</tr>
               		<tr>
               			
               			<td colspan="2"><a th:href="@{deleteoffre(id=${p.id_offre},idc=${p.compte.id} )}"><button class="btn btn-primary btn-block">Delete</button></a></td>
               		</tr>
               </table>
								</div>
                            </div>
