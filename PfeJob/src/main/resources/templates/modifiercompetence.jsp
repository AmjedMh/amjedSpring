...
<head>
 ...
 <form class="form-ad" th:action="@{/ouvrirmodifiercompetence}" method="post" Attribute="offre">
 		<input type="hidden" name="id" th:value="${comp.id_competence}"/>
        <div class="form-group is-empty">
        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Titre</font></font></label>
        <input type="text" th:value="${comp.nomcompp }" name="nomcompp" required="required" class="form-control"/>
        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">id</font></font></label>
        <input type="text" name="mois_experience" th:value="${comp.mois_experience }" required="required" class="form-control"/>
        <span class="material-input"></span>
        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">id</font></font></label>
        <input type="text" name="niveau" th:value="${comp.niveau }" required="required" class="form-control"/>
        <span class="material-input"></span>
         
        </div>
        <input type="submit" class="btn btn-common log-btn" data-toggle="modal" value="Modifer Competence" data-target="#exampleModal"/>
