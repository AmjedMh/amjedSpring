            ...
            <div class="tab-content">
              ...
              <div class="fancy" >
                            ...
                            <div class="top-campaign">
                                <a th:href="@{controlecompte(id=${p.com.id})}"><p th:text="${p.com.email}"></p></a>
                                <div class="table-responsive">
                                   	Lettre de motivation :<br/>
               			 <span th:text="${p.lettre_motivation}"></span>
               		<a th:href="@{deleteDemande(id=${p.id_demande},idc=${p.com.id} )}"><button class="btn btn-primary btn-block">Delete</button></a>
