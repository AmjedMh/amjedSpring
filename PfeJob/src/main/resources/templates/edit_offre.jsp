<html lang="en" xmlns:th="http://www.thymeleaf.org"><head>
  ...
  <li><a class="active" href="candidataccount" role="menuitem" tabindex="-1">My Account</a></li>
  ...
  <li>
  <a class="active" href="candidataccount.jsp">
  My account
  </a>
  </li>
  <li>
  ...
  <li><a class="active" href="candidat.jsp">Resume Page</a></li>
  ...
  <li class="btn-m"><a href="my-account.jsp"><i class="ti-lock"></i> Logout</a></li>
  </ul>
  ...
  <li><a href="candidaaccount.jsp">Add Resume</a></li>
  ...
  <h2 class="product-title">Account</h2>
  <ol class="breadcrumb">
 ...
 <li><a class="active" href="resume.jsp">My Resume</a></li>
  ...
  <ul class="lest item">
  <li><a href="manage-resumes.jsp">offre Management</a></li>
  <li><a href="job-alerts.jsp">Job Alerts</a></li>
  </ul>
  <ul class="lest">
...
<form class="form-ad" th:action="@{/post-job}" method="post" Attribute="offre">
        <div class="form-group is-empty">
        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Titre</font></font></label>
        <input type="text" th:value="${offre.titre }" name="titre" required="required" class="form-control"/>
        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">id</font></font></label>
        <input type="text" name="id_offre" th:value="${offre.id_offre }" required="required" class="form-control"/>
        ...
        <input type="text" th:value="${offre.poste }" required="required" class="form-control"/>
        <span class="material-input"></span></div>
        <div class="form-group is-empty">
...
<option th:value="finance" value=""><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">toutes catégories</font></font></option>
        ...
        <option th:value="Santé" value="Sante"><font style="vertical-align: inherit;">Soins de santé</font></option>
...
<textarea name="description" cols="100" rows="5" required="required" th:text="${offre.description}" class="note-editable" contenteditable="true" ></textarea>
		</div>
					
				
<div class="form-group is-empty">
<label class="control-label">
<font style="vertical-align: inherit;">Date de clôture </font><span><font style="vertical-align: inherit;"><font
	style="vertical-align: inherit;">(optionnel)</font></font></span></label>
	<input type="date" name="date_expiration" class="form-control" required="required" th:value="${offre.date_expiration}" placeholder="yyyy-mm-dd"/>
	<p class="note">
  ...
  <li><a class="color6" href="#"></a></li></ul>
  </div>
  </div>
  <div class="bottom"> <a href="#" class="settings"><i class="ti-settings"></i></a></div> </div></div></div></body></html>