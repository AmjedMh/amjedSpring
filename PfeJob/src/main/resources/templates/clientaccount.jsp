...
<head>
  ...
  <a ><button class="btn btn-common btn-rm">Contacter</button></a>
  </div>
  <div class="about-me item">
 <center><h2><font color="green">About him </font></h2></center> 
  </div>
  ...
  <h5 th:text="${exp.poste_occupee}"> </h5></td></tr><tr><td>
  ...
  <table><tr><td>
  <h4>degree : </h4></td><td><h5 th:text="${form.diplome_obtenu}"> </h5></td></tr><tr><td>
  <h4>Name : </h4></td><td><h5 th:text="${form.nom_etablissement}"></h5></td></tr><tr><td>
