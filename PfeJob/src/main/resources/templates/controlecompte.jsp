        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <a th:href="@{deleteCondidat(idc=${compte.id})}" class="btn btn-primary btn-block"><b>Delete</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Experience</a></li>
              <li><a href="#timeline" data-toggle="tab">Competence</a></li>
              <li><a href="#settings" data-toggle="tab">Formation</a></li>
			  <li><a href="#settingss" data-toggle="tab">Demande</a></li>
            </ul>
            <div class="tab-content">
              <div class="active tab-pane" id="activity">
              <div class="fancy" th:each="exp:${lexp}">
              <table width="100%" >
               		<tr>
               			<td>Date_debut : <span th:text="${exp.date_debut}"></span></td>
               			<td>Date_fin : <span th:text="${exp.date_fin}"></span> </td>
               		</tr>
               		<tr>
               			<td>Poste : <span th:text="${exp.poste_occupee}"></span></td>
               			<td>Societe  : <span th:text="${exp.nom_societe}"></span></td>
               		</tr>
               		<tr>
               			<td>Secteur activite : <span th:text="${exp.secteur_activite}"></span></td>
               			<td><a th:href="@{deleteexperienc(id=${exp.id_experience},idc=${compte.id} )}"><button class="btn btn-primary btn-block">Delete</button></a></td>
               		</tr>
               </table>
              </div>
              ...
              <div class="tab-pane" id="timeline">
                <div class="fancy" th:each="comp:${lcomp}">
              <table width="100%" >
               		<tr>
               			<td>skills name : <span th:text="${comp.nomcompp}"></span></td>
               			
               		</tr>
               		<tr>
               			<td>skills level : <span  th:text="${comp.niveau}"></span></td>
               			
               		</tr>
               		<tr>
               			<td>Month of experiences : <span th:text="${comp.mois_experience}"></span></td>
               			<td><a th:href="@{deleteCompetence(id=${comp.id_competence},idc=${compte.id} )}"><button class="btn btn-primary btn-block">Delete</button></a></td>
               		</tr>
               </table>
              </div>
              </div>
              ...
              <div class="tab-pane" id="settings">
                 <div class="fancy" th:each="form:${lform}">
              <table width="100%" >
               		<tr>
               			<td>Diplome : <span th:text="${form.diplome_obtenu}"></span></td>
               			
               		</tr>
               		<tr>
               			<td>Name etablissement : <span  th:text="${form.nom_etablissement}"></span></td>
               			
               		</tr>
               		<tr>
               			<td>Date : <span  th:text="${form.date_diplome}"></span></td>
               			<td><a th:href="@{deleteFormation(id=${form.id_formation},idc=${compte.id} )}"><button class="btn btn-primary btn-block">Delete</button></a></td>
               		</tr>
               </table>
              </div>
              </div>
			    <div class="tab-pane" id="settingss">
                 <div class="fancy" th:each="let:${ldem}">
              			Lettre de motivation :<br/>
               			 <span th:text="${let.lettre_motivation}"></span>
               		<a th:href="@{deleteDemande(id=${let.id_demande},idc=${compte.id} )}"><button class="btn btn-primary btn-block">Delete</button></a>
