      ...
      <div class="container">
        ...
        <div class="row">
          <div >
            ...
            <div class="col-md-12 job-list"  th:each="p:${offre}">
          ...
          <a Style='width:150px;'  class="btn btn-xs btn-danger" data-toggle="modal" data-target="#exampleModal" >delete</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a type="button" class="btn btn-danger" th:href="@{delete(id_offre=${p.id_offre})}">delete</a>
      </div>
    </div>
  </div>
</div>
         
         </div> </center></td><td><center><div class="action-btn"> <a Style='width:150px;'  class="btn btn-xs btn-success" th:href="@{edit(id_offre=${p.id_offre})}">Edit</a>
         </div></center></td></tr><tr><td colspan="2">
         <hr/>
         <div class="action-btn">  <a Style='width:150px,text-align:right;'  th:href="@{offreDetails(id_offre=${p.id_offre})}" class="btn btn-common btn-rm">More Detail</a>
