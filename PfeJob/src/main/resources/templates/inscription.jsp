...
<html lang = "en" xmlns="http://www.w3.org/1999/xhtml" xmlns:th = "http://www.thymeleaf.org">
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/img/favicon.png" th:href="@{assets/img/favicon.png}"/>
    <!-- Bootstrap CSS -->
  ...
  <body>  
          ...
          <nav class="navbar navbar-default main-navigation" role="navigation" data-spy="affix" data-offset-top="50">
            <div class="container">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand logo" href="login.jsp"><img src="assets/img/logo.png" alt=""/></a>
              </div>
            ...
            <ul class="wpb-mobile-menu">
              ...
              <li>
                ...
                <ul>
                  ...
                  <li><a href="manage-jobs.jspl">Manage Jobs</a></li>
      ...
      <div id="cd-signup" class="is-selected">
        ...
        <div class="page-login-form register" style="margin-left:25%;margin-right:25%;">
        
          <h3>sign up now</h3>
        <form  data-toggle="Validator"  class="login-form" th:action="@{/inscription}" method="post" th:object="${compte}" enctype="multipart/form-data" >
        <div th:if="${errormsg != null}">
          <p class="alert alert-warming alert-dismissable">[[${errormsg}]]</p>
        </div>   
        <div class="form-group is-empty">
        <div class="input-icon">
        <i class="ti-user"></i>
        <input type="text" class="form-control" th:field="*{nom}" placeholder="Username" Required="required" />
        </div>
      ...
      <label for="inputPassword" class="control-label"></label>
        <div class="form-group is-empty">
          <input type="password" th:field="*{password}" data-minlength="8" class="form-control" id="inputPassword" placeholder="Password" Required="required"/>
          <div class="help-block">Minimum of 8 characters</div>
        </div>
        <div class="form-group is-empty">
          <input type="password" name="cpassword" class="form-control" id="inputPasswordConfirm" data-match="#inputPassword" data-match-error="Whoops, these don't match" placeholder="Confirm" Required="required"/>
        ...
        <div class="form-group is-empty">
          <div class="input-icon">
          <i class="ti-mobile"></i>
          <input type="text" name="tel" class="form-control"  th:field="*{tel}" Required="required"/>
          </div>
          <span class="material-input"></span></div>
          <div class="form-group is-empty">
            <div class="input-icon">
            <i class="ti-direction"></i>
            <input type="text" class="form-control" th:field="*{adresse}" placeholder="Adresse" Required="required"/>
            </div>
            <span class="material-input"></span></div>
            <div class="form-group is-empty">
              <div class="input-icon">
              <i class="ti-notepad"></i>
              <input type="date" class="form-control" th:field="*{date_nais}" placeholder="date de naissance" Required="required"/>
              </div>
              <span class="material-input"></span></div>
              <div class="form-group">
                <label>sexe</label>
                <div class="radio">
                    <label><input type="radio" th:field="*{sexe}" value="h"/>Homme</label>
                  
                    <label><input type="radio" th:field="*{sexe}" value="f"/>femme</label>
                  </div>
              </div>
              <div class="form-group">
                <label>type</label>
                <select class="form-control" th:field="*{type}">
                  <option th:value="'R'" th:text="Recruteur">recruteur</option>
                  <option  th:value="'c'" th:text="Candidat">candidat</option>
                
                </select>
              </div>
              <input type="file" name="fileDb" class="custom-file-input">
               <label class="custom-file-label"
					for="customFile">select image</label>
        <input type="submit" value="Enregistrer" class="btn btn-common log-btn" data-toggle="modal" data-target="#exampleModal"/>
</form>
</div>
 </div>
...
s   
    ...
    <!--===============================================================================================-->
	<script src="forgotPass/vendor/jquery/jquery-3.2.1.min.js"></script>
<!--===============================================================================================-->
	<script src="forgotPass/vendor/animsition/js/animsition.min.js"></script>
<!--===============================================================================================-->
	<script src="forgotPass/vendor/bootstrap/js/popper.js"></script>
	<script src="forgotPass/vendor/bootstrap/js/bootstrap.min.js"></script>
<!--===============================================================================================-->
	<script src="forgotPass/vendor/select2/select2.min.js"></script>
<!--===============================================================================================-->
	<script src="forgotPass/vendor/daterangepicker/moment.min.js"></script>
	<script src="forgotPass/vendor/daterangepicker/daterangepicker.js"></script>
<!--===============================================================================================-->
	<script src="forgotPass/vendor/countdowntime/countdowntime.js"></script>
<!--===============================================================================================-->
	<script src="forgotPass/js/main.js"></script>
