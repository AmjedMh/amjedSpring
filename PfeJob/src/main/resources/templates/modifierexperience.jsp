...
<head>
 ...
 <form class="form-ad" th:action="@{/ouvrirmodifierexperience}" method="post" Attribute="offre">
 		<input type="hidden" name="id" th:value="${exp.id_experience}"/>
        <div class="form-group is-empty">
        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">name societe</font></font></label>
        <input type="text" th:value="${exp.nom_societe }" name="nom_societe" required="required" class="form-control"/>
        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">id</font></font></label>
        <input type="text" name="secteur_activite" th:value="${exp.secteur_activite }" required="required" class="form-control"/>
        <span class="material-input"></span>
        <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">id</font></font></label>
        <input type="text" name="poste_occupee" th:value="${exp.poste_occupee }" required="required" class="form-control"/>
        <span class="material-input"></span>
         <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">id</font></font></label>
        <input type="date" name="date_debut" th:value="${exp.date_debut }" required="required" class="form-control"/>
        <span class="material-input"></span>
         <label class="control-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">id</font></font></label>
        <input type="date" name="date_fin" th:value="${exp.date_fin }" required="required" class="form-control"/>
        <span class="material-input"></span>
        </div>
        <input type="submit" class="btn btn-common log-btn" data-toggle="modal" value="Modifer Experience" data-target="#exampleModal"/>
