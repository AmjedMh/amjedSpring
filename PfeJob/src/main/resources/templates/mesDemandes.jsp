...
<h3 class="alerts-title">Mes Demandes</h3>
<div class="applications-content" th:each="p:${demande}">
<div class="row">
<div class="col-md-5"> 
<div class="thums">
<img src="assets/img/jobs/img-1.jpg" alt=""/>
</div>
<h3 th:text="${p.email}"></h3>
<h3 th:text="${p.lettre_motivation}"></h3>
</div>
<div class="col-md-2">
<h3 th:text="${p.off.titre}"></h3>
<p th:if="${p.etat == 1}"><font color="green">Accepted</font></p>
<p th:if="${p.etat == 2}"><font color="red">Refused</font></p>
<p th:if="${p.etat == 0}"><font color="orange">en attend</font></p>
</div>
</div>
</div>
