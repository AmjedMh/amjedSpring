...
<head>
  ...
  <form class="form" th:action="@{changepassword}" method="post">
  ...
  <input class="form-control" name="password" id="inputPassword" type="password" Required="required"/>
  <span class="material-input"></span>
  <span class="material-input"></span></div>
  <div class="form-group is-empty">
    <label class="control-label" for="textarea">Confirm Password*</label>
    <input class="form-control" name="password" id="inputPasswordConfirm" type="password" data-match="#inputPassword" data-match-error="Whoops, these don't match"/>
    <span class="material-input"></span>
    <span class="material-input"></span></div>
